 ...
 * Use the {@link Frag2Courses#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Frag2Courses extends Fragment implements View.OnClickListener {
    ...
    public static Frag2Courses newInstance(String param1, String param2) {
        Frag2Courses fragment = new Frag2Courses();
...
//        args.putIntegerArrayList("arrayList",GlobalVariablesClass.courseCodesList);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_frag2_courses,container,false);
...
//        }
        ...
        if(GlobalVariablesClass.courseCodesList.contains(2)){
            int color = Color.parseColor("#228B22");
            checkBox.setColorFilter(color);
        }
