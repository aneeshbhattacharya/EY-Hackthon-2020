 ...
 * Use the {@link Frag3Courses#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Frag3Courses extends Fragment implements View.OnClickListener {
    ...
    public static Frag3Courses newInstance(String param1, String param2) {
        Frag3Courses fragment = new Frag3Courses();
...
//        args.putIntegerArrayList("arrayList",GlobalVariablesClass.courseCodesList);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_frag3_courses,container,false);
...
//        }
        ...
        if(GlobalVariablesClass.courseCodesList.contains(3)){
            int color = Color.parseColor("#228B22");
            checkBox.setColorFilter(color);
        }
